...
def run_hunyuan_model(
    ...
    # Default prompt if empty - optimized for Arabic OCR
    query = custom_prompt if custom_prompt else "قم باكتشاف وتعرّف على النص العربي في الصورة. استخرج جميع النصوص العربية بدقة مع الحفاظ على الاتجاه من اليمين إلى اليسار. Extract and recognize Arabic text in the image. Preserve right-to-left reading direction and maintain accurate Arabic character recognition."
...
with gr.Blocks() as demo:
    gr.Markdown("# **HunyuanOCR Arabic Demo**", elem_id="main-title")
    gr.Markdown("Demonstration of **tencent/HunyuanOCR** for Arabic text extraction and recognition.")
    ...
    with gr.Row():
        with gr.Column(scale=1):
            ...
            custom_prompt = gr.Textbox(
                ...
                placeholder="Enter prompt for Arabic OCR...", 
                lines=2, 
                value="قم باكتشاف وتعرّف على النص العربي في الصورة. استخرج جميع النصوص العربية بدقة مع الحفاظ على الاتجاه من اليمين إلى اليسار. Extract and recognize Arabic text in the image. Preserve right-to-left reading direction and maintain accurate Arabic character recognition."
            )
